...
export default defineConfig({
  ...
  testMatch: [
    ...
    /hari-2026-06-08-bugs\.spec\.ts/,
    /hari-2026-06-09-bugs\.spec\.ts/,
    /hari-2026-06-23-bugs\.spec\.ts/,
    /hari-2026-06-24-bugs\.spec\.ts/,
    /hari-2026-06-25-bugs\.spec\.ts/,
    /hari-2026-06-26-bugs\.spec\.ts/,
    /hari-2026-06-27-bugs\.spec\.ts/,
    /hari-2026-06-29-bugs\.spec\.ts/,
    /hari-2026-06-30-bugs\.spec\.ts/,
    /hari-2026-07-02-bugs\.spec\.ts/,
    /hari-2026-07-03-bugs\.spec\.ts/,
    /hari-2026-07-07-bugs\.spec\.ts/,
    /ram-2026-09-03-prod\.spec\.ts/,
    /notice-module\.spec\.ts/,
