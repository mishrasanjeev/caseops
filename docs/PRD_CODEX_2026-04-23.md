...
- automatic case tracking must update only an exact unique CNR or exact
  case-number-plus-court match; not-found, ambiguity, provider mismatch, and
  invalid identifiers must not mutate the matter
