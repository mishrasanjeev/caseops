...
history and fail-closed exclusions. Complete current Docker API, PostgreSQL and
browser evidence passes; exact-production acceptance is still pending. Source truth and
