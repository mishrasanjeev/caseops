# Licensing And Assignment Child PRD
...
IPLF-090A/090B; LIC-01; UJ-43; IP-SCOPE-01 through IP-SCOPE-10.
...
User story: an authorized specialist records grantor, grantee, affected rights as supplied, territory, field, exclusivity, supplied term, confidential royalty terms and interpretation issue without borrowing trademark
...
Agreement clauses cite exact version and locator. Ambiguity remains a review issue. Contractual interests, registry title, licence permission and billing are independent. Termination retains historical terms.
...
Required source pack: Executed tenant agreement with version/page provenance; applicable right-specific recordal forms and official fee/rule sources. No invented royalty, notice period or deadline.
...
Stable local tests: OIP-licensing-intake, OIP-licensing-observation,
