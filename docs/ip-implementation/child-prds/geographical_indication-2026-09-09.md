# Geographical Indications Child PRD
...
IPLF-091A/091B; GI-01; UJ-44; IP-SCOPE-01 through IP-SCOPE-10.
...
User story: an authorized specialist records applicant or association, geographical area, goods, supplied specification and authorised-user claim without borrowing trademark
...
An authorised-user claim is not accepted registration. Territory/specification versions remain distinct. Public registry facts do not disclose confidential know-how.
...
Required source pack: GI Act and applicable Rules; official specification, authorised-user, opposition, registration, publication and renewal packs with exact forms and fee editions.
...
Stable local tests: OIP-geographical_indication-intake, OIP-geographical_indication-observation,
