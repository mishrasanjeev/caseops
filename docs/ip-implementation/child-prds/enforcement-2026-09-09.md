...
IPLF-090A/090B; ENF-01; UJ-45 contextual allocation; IP-SCOPE-01 through IP-SCOPE-10.
...
User story: an authorized specialist records represented party, asserted right, allegation, proposed channel and alleged party without borrowing trademark
...
Allegations remain allegations. Investigation, notices, platform outcomes and court orders are evidence, not automatic infringement determinations. No outbound action is executed by this intake.
...
Required source pack: Tenant instruction and right evidence; exact official procedure for proposed forum/channel and applicable platform policies, including retained evidence and lawful-use constraints.
...
Stable local tests: OIP-enforcement-intake, OIP-enforcement-observation,
