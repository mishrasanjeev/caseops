# Customs And Anti-Counterfeiting Child PRD
...
IPLF-091A/091B; CUSTOMS-01; UJ-45; IP-SCOPE-01 through IP-SCOPE-10.
...
User story: an authorized specialist records right holder, asserted right, products, authority/channel, authentication-guide custodian, authorised-importer policy and instruction reference without borrowing trademark
...
Suspected goods are not confirmed counterfeit. An authenticity-review source does not itself determine infringement. Release, detention and destruction are separate observations. Sensitive guides remain restricted.
...
Required source pack: Official customs IPR enforcement rules, current notices/procedure, forms, bonds/fees and recordal scope; tenant instruction, product/authentication and lawful custody evidence.
...
Stable local tests: OIP-customs_enforcement-intake, OIP-customs_enforcement-observation,
