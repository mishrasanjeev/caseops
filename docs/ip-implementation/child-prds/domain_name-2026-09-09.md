...
IPLF-090A/090B; DOMAIN-01; UJ-45 contextual allocation; IP-SCOPE-01 through IP-SCOPE-10.
...
User story: an authorized specialist records domain name, registrar, supplied registrant, supplied expiry and dispute channel without borrowing trademark
...
Supplied expiry is a fact, not a calculated deadline. Registrar identity and dispute policies are never guessed. A dispute decision does not silently transfer ownership.
...
Required source pack: Exact registrar terms and renewal policy; current official UDRP/Rules and applicable INDRP policy/procedure editions for each explicitly supported channel.
...
Stable local tests: OIP-domain_name-intake, OIP-domain_name-observation,
