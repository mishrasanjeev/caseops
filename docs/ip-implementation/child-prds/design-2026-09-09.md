...
IPLF-090A/090B; DES-01; UJ-30, UJ-41; IP-SCOPE-01 through IP-SCOPE-10.
...
User story: an authorized specialist records applicant, article, supplied classification, novelty statement, representation description and publication instruction without borrowing trademark
...
Representation sets and revised representations remain separate source versions. Cancellation remains an independent contested process, not a trademark opposition. Variants cannot share legal identity by label.
...
Required source pack: Designs Act and applicable Rules; official representation, classification, form, fee, examination, registration, publication, extension and cancellation sources, each exact edition and commencement context.
...
Stable local tests: OIP-design-intake, OIP-design-observation,
