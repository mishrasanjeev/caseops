# Semiconductor Layouts Child PRD
...
IPLF-091A/091B; SICLD-01; UJ-44; IP-SCOPE-01 through IP-SCOPE-10.
...
User story: an authorized specialist records creator, supplied proprietor, layout description, first commercial exploitation and exploitation territory without borrowing trademark
...
Layout versions are never overwritten. Exploitation facts do not calculate term or determine novelty. Licensing and opposition are separate evidence types.
...
Required source pack: Official semiconductor integrated-circuit layout-design legislation, Rules, registry practice/forms/fees and exploitation/registration sources with edition context.
...
Stable local tests: OIP-semiconductor_layout-intake, OIP-semiconductor_layout-observation,
