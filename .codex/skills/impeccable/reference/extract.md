...
**CRITICAL**: If no design system exists, STOP and call the the user for concise clarification. before creating one. Understand the preferred location and structure first.
