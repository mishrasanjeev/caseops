...
class TestTitleIsCaseName:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            ("(VIA VIDEO-CONFERENCING)", "bench_header_or_thin"),
            ("Date of Judgment : 14th October, 2019", "bench_header_or_thin"),
            ("Date of Decision : 8th March, 2019", "bench_header_or_thin"),
            ("Signature Not Verified", "bench_header_or_thin"),
            ("Short", "too_short"),
            ("", "empty"),
            ("   ", "empty"),
        ],
