...
def _build_messages(
    ...
    base_system = (
        ...
        "it in the summary; do not paper over it. **When three or more "
        "authorities are supplied, the body MUST cite at least three of "
        "them; one bracketed citation is the absolute floor only when "
        "fewer than three are available.** Procedural-only filings "
        "(vakalatnama, caveat petition, plain affidavit, statutory "
        "notices that recite the section verbatim) are exempt — for "
        "those, citing only when relevant is correct.\n"
