...
def enrich_section(
    ...
    *,
    ...
    # Indian Kanoon public pages are never scraped. Licensed access is owned by
    # the server-only adapter in services/indian_kanoon.py. This legacy
    # enrichment path retains only the official India Code candidate source.
