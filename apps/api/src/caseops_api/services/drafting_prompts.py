...
_ANTICIPATORY_BAIL = PromptParts(
    system=(
        ...
        " 2. Reasonable apprehension of arrest — specific facts, not "
        "generic fear.\n"
        " 3. Why custodial interrogation is unnecessary (cooperate, "
        "documents already produced, s.41A notice compliance).\n"
        " 4. Precedents: Gurbaksh Singh Sibbia, Sushila Aggarwal, Arnesh "
        "Kumar (where applicable to s.41A).\n"
        " 5. Prayer — pre-arrest bail with conditions.\n"
        "RULES:\n"
...
_CHEQUE_BOUNCE = PromptParts(
    system=(
        ...
        "days of receipt of the notice. NEVER substitute a different "
        "period — the statute mandates 15 days.\n"
        " 6. Warning: on non-payment, the sender will prosecute under "
        "s.138 NI Act + may claim double the cheque amount under "
        "s.142.\n"
        "RULES:\n"
...
_CRIMINAL_COMPLAINT = PromptParts(
    system=(
        ...
        " 2. Jurisdiction paragraph — territorial + BNSS competence.\n"
        ...
        " 8. Prayer: cognisance under BNSS s.227, summon the accused, "
...
_CIVIL_SUIT = PromptParts(
    system=(
        ...
        " 7. Relief sought — one relief per clause of the prayer.\n"
