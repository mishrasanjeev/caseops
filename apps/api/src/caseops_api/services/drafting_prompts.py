...
_ANTICIPATORY_BAIL = PromptParts(
    system=(
        ...
        "Grounds section MUST contain at least three distinct "
        "bracketed inline anchors. Citations in the JSON `citations` "
        "field MUST also appear inline.\n"
        "FEW-SHOT EXEMPLAR for the Grounds section:\n"
        "  'Ground A: The applicant has reasonable apprehension of "
        "  arrest within the meaning of BNSS s.482 [(1980) 2 SCC 565]. "
        "  The Hon'ble Supreme Court in Sushila Aggarwal "
        "  [(2020) 5 SCC 1] held that anticipatory bail is not "
        "  time-limited by default. Ground B: The applicant has "
        "  cooperated and complied with s.41A BNSS notice [(2014) 8 "
        "  SCC 273]; custodial interrogation is unnecessary.'\n"
        "REQUIRED STRUCTURE:\n"
