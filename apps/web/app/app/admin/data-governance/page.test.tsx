...
const { fetchMock, historyMock, detailMock, capabilityMock } = vi.hoisted(() => ({ fetchMock: vi.fn(), historyMock: vi.fn(), detailMock: vi.fn(), capabilityMock: vi.fn() }));
vi.mock("@/lib/api/endpoints", () => ({ fetchTenantDataGovernanceIntegrity: fetchMock, listTenantDataOperationDryRuns: historyMock, fetchTenantDataOperationDryRun: detailMock }));
