...
import DraftingHubPage from "@/app/app/drafting/page";
...
describe("DraftingHubPage", () => {
  beforeEach(() => {
    listMattersMock.mockReset();
  });

  it("renders the Drafting studio header and lists matters as drafting entry-points", async () => {
    ...
    render(withClient(<DraftingHubPage />));
    expect(screen.getByText(/Drafting studio/i)).toBeInTheDocument();
