...
export default function HomePage() {
  ...
  async function loadContext(currentToken: string) {
    const [authContext, usersPayload, profilePayload, mattersPayload, contractsPayload] =
      await Promise.all([
  ...
  async function handleUploadAttachment(event: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      setNotice("Document uploaded to the matter workspace.");
    } catch (error) {
    ...
    <main className="page-shell">
      <section className="hero">
        <div className="hero-copy">
          <p className="eyebrow">CaseOps</p>
          <h1>The legal operating system for matters, teams, and AI workflows.</h1>
          <p className="lede">
            The founder console now covers bootstrap, login, company profile management, user
            management, matter operations, billing, and contract workspace workflows in one place.
          </p>
        </div>

        <div className="hero-panel">
          <span className="label">Founder slice</span>
          <strong>Company profile + matters + contracts + admin console</strong>
          <p>
            The backend now has explicit migrations, a richer company profile, matter and contract
            lifecycle primitives, billing rails, and the first explainable AI workflow on top of
            the auth and tenancy foundation.
          </p>
        </div>
      </section>
      ...
      <section className="dashboard">
        ...
        <div className="workspace-card">
          ...
          {loggedIn ? (
            <form className="form-grid" onSubmit={handleUpdateCompanyProfile}>
              <label>
                Company name
                <input
      ...
      <section className="dashboard">
        <div className="workspace-card">
          ...
          {loggedIn && matterWorkspace ? (
            <form className="form-grid compact" onSubmit={handleAddTimeEntry}>
              <label>
                Work date
                <input
                  type="date"
        ...
        <div className="workspace-card">
          ...
          {loggedIn && matterWorkspace ? (
            <>
              <form className="form-grid compact" onSubmit={handleCreateInvoice}>
                <label>
                  Invoice number
                  <input
      ...
      <section className="dashboard">
        ...
        <div className="workspace-card">
          ...
          {loggedIn ? (
            <>
              <form className="form-grid compact" onSubmit={handleCreateMatter}>
                <label>
                  Matter title
                  <input
      ...
      <section className="dashboard">
        <div className="workspace-card">
          ...
          {loggedIn && matterWorkspace ? (
            <>
              <form className="form-grid compact" onSubmit={handleUpdateMatterWorkspace}>
                <label>
                  Status
                  <select
        ...
        <div className="workspace-card">
          ...
          {loggedIn && matterWorkspace ? (
            <>
              <form className="form-grid compact" onSubmit={handleGenerateBrief}>
                <label>
                  Brief type
                  <select
        ...
        <div className="workspace-card">
          ...
          {loggedIn && matterWorkspace ? (
            <>
              <form className="form-grid compact" onSubmit={handleAddMatterNote}>
                <label className="full-span">
                  Internal note
                  <textarea
                    value={noteForm.body}
              ...
              <form className="form-grid compact" onSubmit={handleAddMatterHearing}>
                <label>
                  Hearing date
                  <input
                    type="date"
              ...
              <form className="form-grid compact" onSubmit={handleUploadAttachment}>
                <label className="full-span">
                  Matter document
                  <input
      ...
      <section className="dashboard">
        ...
        <div className="workspace-card">
          <div className="card-head">
            ...
            <span className="pill">
              {matterWorkspace
                ? `${matterWorkspace.attachments.length + matterWorkspace.time_entries.length + matterWorkspace.invoices.length + matterWorkspace.notes.length + matterWorkspace.hearings.length} items`
                : "No items"}
            </span>
          </div>
      ...
      <section className="workspace">
        <div className="workspace-card">
          ...
          {loggedIn ? (
            <>
              <form className="form-grid" onSubmit={handleCreateContract}>
                <label>
                  Contract title
                  <input
        ...
        <div className="workspace-card">
          ...
          {loggedIn && contractWorkspace ? (
            <>
              <form className="form-grid compact" onSubmit={handleUpdateContractWorkspace}>
                <label>
                  Status
                  <select
        ...
        <div className="workspace-card">
          ...
          {loggedIn && contractWorkspace ? (
            <>
              ...
              <form className="form-grid compact" onSubmit={handleAddContractObligation}>
                <label>
                  Obligation owner
                  <select
              ...
              <form className="form-grid compact" onSubmit={handleAddContractPlaybookRule}>
                <label>
                  Rule name
                  <input
