...
- **Case tracking**: active matters with a reliable CNR or exact case-number-plus-court identity, plus explicit bookmarks, refresh in bounded batches from 6 PM-8 PM IST; disabled or misconfigured providers make no external calls and record blocked/skipped state
